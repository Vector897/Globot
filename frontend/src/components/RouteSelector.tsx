...
export function RouteSelector({ routes, selectedRoute, onRouteSelect }: RouteSelectorProps) {
  ...
  return (
    <motion.div
      className="absolute top-20 left-6 bg-[#0f1621]/98 border border-[#1a2332] rounded-sm flex flex-col z-20"
    ...
    >
      ...
      {/* Resize Handle */}
      <div 
        className="absolute top-0 bottom-0 -right-1 w-2 cursor-col-resize hover:bg-[#4a90e2]/50 transition-colors z-50 rounded-r-sm"
